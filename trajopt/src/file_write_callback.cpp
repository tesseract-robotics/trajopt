...
namespace trajopt
{
  ...
  void WriteFile(ofstreamPtr file, vector<Affine3d> pose_inverses, Affine3d tcp, TrajOptProbPtr prob, DblVec& x,
  ...
  Optimizer::Callback WriteCallback(string file_name, TrajOptProbPtr prob, vector<string> joint_names, vector<Affine3d> pose_inverses,
