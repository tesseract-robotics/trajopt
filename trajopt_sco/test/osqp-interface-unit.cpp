...
TEST(osqp_interface, triplet_to_CSC_sparse)
{
  ...
  tripletsToCSC(rows_i, cols_p, P, 3, 3, 7, data_i, data_j, data_vij);
  ...
  tripletsToCSC(rows_i, cols_p, P, 3, 3, 3, data_i, data_j, data_vij);
...
TEST(osqp_interface, triplet_to_CSC_sparse_upper_triangular)
{
  ...
  tripletsToCSC(rows_i, cols_p, P, 3, 3, 5, data_i, data_j, data_vij, true);
