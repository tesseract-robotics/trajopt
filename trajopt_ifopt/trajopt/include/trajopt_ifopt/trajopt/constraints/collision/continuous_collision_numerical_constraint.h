/**
 * @file continuous_collision_numerical_constraint.h
 ...
 */
#ifndef TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_NUMERICAL_CONSTRAINT_H
#define TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_NUMERICAL_CONSTRAINT_H
...
public:
  ...
  using ConstPtr = std::shared_ptr<const ContinuousCollisionNumericalConstraint>;
...
#endif  // TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_NUMERICAL_CONSTRAINT_H
