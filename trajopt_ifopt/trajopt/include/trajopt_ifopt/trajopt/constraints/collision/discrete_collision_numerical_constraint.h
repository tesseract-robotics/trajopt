 ...
 */
#ifndef TRAJOPT_IFOPT_TRAJOPT_DISCRETE_COLLISION_NUMERICAL_CONSTRAINT_H
#define TRAJOPT_IFOPT_TRAJOPT_DISCRETE_COLLISION_NUMERICAL_CONSTRAINT_H
...
#endif  // TRAJOPT_IFOPT_TRAJOPT_DISCRETE_COLLISION_NUMERICAL_CONSTRAINT_H
