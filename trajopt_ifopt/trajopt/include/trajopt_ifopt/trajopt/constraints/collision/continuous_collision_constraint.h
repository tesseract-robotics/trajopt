 ...
 */
#ifndef TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_CONSTRAINT_V2_H
#define TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_CONSTRAINT_V2_H
...
#endif  // TRAJOPT_IFOPT_TRAJOPT_CONTINUOUS_COLLISION_CONSTRAINT_H
