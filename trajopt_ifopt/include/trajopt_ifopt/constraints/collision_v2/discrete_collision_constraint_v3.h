...
{
class DiscreteCollisionConstraintIfoptV3 : public ifopt::ConstraintSet
{
public:
  using Ptr = std::shared_ptr<DiscreteCollisionConstraintIfoptV3>;
  using ConstPtr = std::shared_ptr<const DiscreteCollisionConstraintIfoptV3>;

  DiscreteCollisionConstraintIfoptV3(DiscreteCollisionEvaluator::Ptr collision_evaluator,
