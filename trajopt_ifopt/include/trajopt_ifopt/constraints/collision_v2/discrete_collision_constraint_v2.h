 ...
 */
#ifndef TRAJOPT_IFOPT_COLLISION_CONSTRAINT_V2_H
#define TRAJOPT_IFOPT_COLLISION_CONSTRAINT_V2_H
...
{
class DiscreteCollisionConstraintIfoptV2 : public ifopt::ConstraintSet
{
public:
  using Ptr = std::shared_ptr<DiscreteCollisionConstraintIfoptV2>;
  using ConstPtr = std::shared_ptr<const DiscreteCollisionConstraintIfoptV2>;

  DiscreteCollisionConstraintIfoptV2(DiscreteCollisionEvaluator::Ptr collision_evaluator,
                                     std::vector<tesseract_collision::ObjectPairKey> collision_object_pairs,
                                     JointPosition::ConstPtr position_var,
                                     const std::string& name = "DiscreteCollisionV2");
...
private:
  ...
  std::vector<tesseract_collision::ObjectPairKey> collision_object_pairs_;
};
};  // namespace trajopt_ifopt
#endif
