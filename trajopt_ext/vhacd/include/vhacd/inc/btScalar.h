...
inline int32_t btGetVersion() { return BT_BULLET_VERSION; }
...
SIMD_FORCE_INLINE int32_t btIsNegative(btScalar x) { return x < btScalar(0.0) ? 1 : 0; }
...
SIMD_FORCE_INLINE unsigned btSwapEndian(int32_t val) { return btSwapEndian((unsigned)val); }
...
/// exception.
/// In most systems, running user mode code, you wouldn't get an exception, but instead the hardware/os/runtime will
